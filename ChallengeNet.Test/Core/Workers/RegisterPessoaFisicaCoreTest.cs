...
{
    public class RegisterPessoaFisicaCoreTest
    {
        [Fact]
        public async Task ShouldCreatePessoaFisicaWhenPayloadIsValid()
        {
            ...
            var loggerMock = new Mock<ILogger<RegisterPessoaFisicaCore>>();

            var worker = new RegisterPessoaFisicaCore(repositoryMock.Object, loggerMock.Object);
