...
{
    public class RegisterPessoaJuridicaCoreTest
    {
        [Fact]
        public async Task ShouldCreatePessoaJuridicaWhenPayloadIsValid()
        {
            ...
            var loggerMock = new Mock<ILogger<RegisterPessoaJuridicaCore>>();

            var worker = new RegisterPessoaJuridicaCore(repositoryMock.Object, loggerMock.Object);
            #endregion
